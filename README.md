...
![Miami](/app/opengraph-image.png)

A minimalistic AI-powered search engine that helps you find information on the internet.

🔗 **[Try Miami at miami.ai](https://miami.ai)**

[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/zaidmukaddam/miami)
...
[![Warp](https://github.com/user-attachments/assets/2bda420d-4211-4900-a37e-e3c7056d799c)](https://www.warp.dev/?utm_source=github&utm_medium=referral&utm_campaign=miami)<br>

### **[Warp, the intelligent terminal](https://www.warp.dev/?utm_source=github&utm_medium=referral&utm_campaign=miami)**<br>

[Available for MacOS, Linux, & Windows](https://www.warp.dev/?utm_source=github&utm_medium=referral&utm_campaign=miami)<br>
[Visit warp.dev to learn more](https://www.warp.dev/?utm_source=github&utm_medium=referral&utm_campaign=miami)
...
4. **Set the search engine name**:
   - Enter `Miami` in the "Search engine" field.

5. **Set the search engine URL**:
   - Enter `https://miami.ai?q=%s` in the "URL with %s in place of query" field.
...
After completing these steps, you should be able to use Miami as your default search engine in Chrome.
...
2. Build the Docker image:
   ```bash
   docker build -t miami.app .
   ```
3. Run the container:
   ```bash
   docker run --env-file .env -p 3000:3000 miami.app
   ```
