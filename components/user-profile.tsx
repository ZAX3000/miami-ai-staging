    ...
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DropdownMenuContent className="w-[240px] z-[110] mr-5">
        ...
        <DropdownMenuItem className="cursor-pointer" asChild>
          <a href={'https://api.miami.ai/'} target="_blank" className="w-full flex items-center gap-2">
            <CodeIcon size={16} />
            <span>API</span>
          </a>
        </DropdownMenuItem>
        ...
        <DropdownMenuItem className="cursor-pointer" asChild>
          <a href={'https://git.new/miami'} target="_blank" className="w-full flex items-center gap-2">
            <GithubLogoIcon size={16} />
            <span>Github</span>
          </a>
        </DropdownMenuItem>
        <DropdownMenuItem className="cursor-pointer" asChild>
          <a href={'https://x.com/miamiai'} target="_blank" className="w-full flex items-center gap-2">
            <XLogoIcon size={16} />
            <span>X.com</span>
          </a>
        </DropdownMenuItem>
        <DropdownMenuItem className="cursor-pointer" asChild>
          <a href={'https://www.instagram.com/miami.ai'} target="_blank" className="w-full flex items-center gap-2">
        ...
        <DropdownMenuItem className="cursor-pointer" asChild>
          <a href={'https://miami.userjot.com'} target="_blank" className="w-full flex items-center gap-2">
