...
`
    : ''
}I am a current student at this university and would love to access the student discount for Miami Pro.
...
Best regards`;
  ...
  const handleSubmit = () => {
    ...
    const mailtoLink = `mailto:zaid@miami.ai?subject=${encodeURIComponent(subject)}&body=${formattedBody}`;
