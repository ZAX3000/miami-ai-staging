...
const testimonials = [
  {
    content:
      '"Miami @miamiai is better than Grok at digging up information from X, its own platform! I asked it 3 different queries to help scrape and find some data points I was interested in about my own account and Miami did much much better with insanely accurate answers!"',
    author: 'Chris Universe',
    handle: '@chrisuniverseb',
    link: 'https://x.com/chrisuniverseb/status/1943025911043100835',
  },
  {
    content: '"miami dot ai does a really good job scraping through the reddit mines btw"',
    author: 'nyaaier',
    handle: '@nyaaier',
  ...
  {
    content:
      "Hi @miamiai, just for curiosity, I searched for myself using its Gemini 2.5 Pro and in extreme mode to see what results it could generate. And it created this 👇🏻 It is not just the best, it is wild. And the best part is it's 10000% accurate.",
  ...
  {
    content:
      '"read nothing the whole sem and here I am with @miamiai to top my mid sems !! Literally so good to get all the related diagram, points and even topics from the website my professor uses to teach us 🙌"',
    author: 'Rajnandinit',
        ...
        <div className="flex-1 flex flex-col justify-between p-12">
          <div className="flex items-center gap-2">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-lg font-medium">Miami AI</span>
            </Link>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-4 text-sm text-muted-foreground">
              <a href="https://git.new/miami" target="_blank" className="hover:text-foreground transition-colors">
                Open Source
              </a>
              <span>•</span>
            ...
            <p className="text-xs text-muted-foreground">
              ...
              •{' '}
              <a
                href="https://peerlist.io/zaidmukaddam/project/miami-ai-20"
                target="_blank"
                className="hover:text-foreground transition-colors"
              >
