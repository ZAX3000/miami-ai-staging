...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> {
  ...
  // if not chat, return Miami Chat
  if (!chat) {
    return { title: 'Miami Chat' };
  }
  let title;
  ...
  return {
    title: title,
    description: 'A search in miami.ai',
    openGraph: {
      title: title,
      url: `https://miami.ai/search/${id}`,
      description: 'A search in miami.ai',
      siteName: 'miami.ai',
      images: [
        {
          url: `https://miami.ai/api/og/chat/${id}`,
          width: 1200,
          height: 630,
        },
      ],
    ...
    alternates: {
      canonical: `https://miami.ai/search/${id}`,
    },
  } as Metadata;
}
