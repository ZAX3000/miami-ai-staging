    ...
    <div className="min-h-screen bg-background">
            ...
            <motion.div variants={item} className="text-center">
              <Link href="/" className="inline-flex items-center gap-3 font-be-vietnam-pro font-bold">
                <div className="relative w-14 h-14 rounded-full bg-background/90 shadow-sm flex items-center justify-center border">
                  <MiamiLogo className="size-8 opacity-90" />
                </div>
              </Link>
            </motion.div>
      ...
      <div className="py-16 px-4">
        <div className="container max-w-3xl mx-auto prose dark:prose-invert prose-neutral prose-headings:font-be-vietnam-pro prose-p:text-muted-foreground prose-a:text-foreground prose-a:no-underline hover:prose-a:text-foreground/80 prose-headings:tracking-tight">
          <p className="text-lg">
            Welcome to Miami AI. These Terms of Service govern your use of our website and services. By using Miami AI,
          ...
          <p>
            By accessing or using Miami AI, you acknowledge that you have read, understood, and agree to be bound by
            these Terms of Service. We reserve the right to modify these terms at any time, and such modifications shall
            be effective immediately upon posting. Your continued use of Miami AI after any modifications indicates your
            acceptance of the modified terms.
          </p>

          <h2>2. Description of Service</h2>
          <p>
            Miami AI is a minimalistic AI-powered search engine that helps users find information on the internet. Our
          ...
          <p>You agree not to use Miami AI to:</p>
          <ul>
          ...
          <p>While we strive to provide accurate and reliable information, Miami AI:</p>
          <ul>
          ...
          <p>
            ...
            Miami AI should not be used as the sole source for making important decisions, especially in professional,
            medical, legal, or financial contexts.
          </p>

          <h2>5. Intellectual Property</h2>
          <p>
            All content, features, and functionality of Miami AI, including but not limited to text, graphics, logos,
            icons, images, audio clips, and software, are the property of Miami AI or its licensors and are protected by
          ...
          <p>Miami AI relies on third-party services to provide its functionality:</p>
          <ul>
          ...
          <p>
            By using Miami AI, you acknowledge and agree that your data may be processed by these third-party services
          ...
          <p>
            Miami AI offers both free and paid subscription plans. For detailed pricing information, visit our{' '}
          ...
          <ul>
            ...
            <li>
              <strong>Miami Pro:</strong> $15/month subscription with unlimited searches and access to all AI models
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Important:</strong> Miami AI does not store any payment card details, bank information, or other
          ...
          <h2>9. Privacy</h2>
          <p>
            Your use of Miami AI is also governed by our{' '}
          ...
          <p>
            To the maximum extent permitted by law, Miami AI shall not be liable for any indirect, incidental, special,
          ...
          <p>
            Miami AI is provided &quot;as is&quot; and &quot;as available&quot; without any warranties of any kind,
          ...
          <p>
            We reserve the right to suspend or terminate your access to Miami AI, with or without notice, for conduct
          ...
          <p>
            ...
            Miami AI operates, without regard to its conflict of law provisions.
          </p>

          <h2>14. Contact Us</h2>
          <p>If you have any questions about these Terms of Service, please contact us at:</p>
          <p>
            <a href="mailto:zaid@miami.ai" className="flex items-center gap-1">
              zaid@miami.ai <ExternalLink className="h-4 w-4" />
            </a>
          </p>

          <div className="my-8 border-t pt-8">
            <p className="text-sm text-muted-foreground">
              By using Miami AI, you agree to these Terms of Service and our{' '}
              <Link href="/privacy-policy" className="underline">
                Privacy Policy
              </Link>
              .
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-background border flex items-center justify-center">
                <MiamiLogo className="size-4 opacity-80" />
              </div>
              <div className="text-sm text-muted-foreground">
                © {new Date().getFullYear()} Miami AI by Zaid Mukaddam
              </div>
            </div>
