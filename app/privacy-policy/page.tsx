    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="py-16 px-4">
        <div className="container max-w-3xl mx-auto prose dark:prose-invert prose-neutral prose-headings:font-be-vietnam-pro prose-p:text-muted-foreground prose-a:text-foreground prose-a:no-underline hover:prose-a:text-foreground/80 prose-headings:tracking-tight">
          <p className="text-lg">
            At Miami AI, we respect your privacy and are committed to protecting your personal data. This Privacy Policy
          ...
          <p>
            <strong>Important Note on Payment Data:</strong> Miami AI does not collect, store, or process any payment
          ...
          <div className="my-8 border-t pt-8">
            <p className="text-sm text-muted-foreground">
              By using Miami AI, you agree to our Privacy Policy and our{' '}
